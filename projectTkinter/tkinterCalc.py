...
# Set up buttons
filler1_lable = Label(button_Menu, width=30, bg="#1E76CB")
filler1_lable.grid(row=0, column=0)

filler2_lable = Label(button_Menu, width=30, bg="#1E76CB")
filler2_lable.grid(row=7, column=6)
